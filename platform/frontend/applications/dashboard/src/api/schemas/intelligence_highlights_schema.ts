/**
 * Copied from ../../../../../backend/platform/src/intelHighlightsMerger/schema.ts
 */
...
import { EpssDataRowSchema } from "./epss_schema";
import { CisaKevVulnerabilitySchema } from "./cisa_kev_catalog_schema";
